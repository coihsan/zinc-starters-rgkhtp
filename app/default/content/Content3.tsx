...
export default function Content3(){
    return(
        <section className="max-w-screen-xl mx-auto px-[1rem] py-[7rem] max-[600px]:py-[3rem] flex justify-evenly gap-5 max-[600px]:flexCol">
                <Image className="w-[50%] max-[600px]:w-[100%] rounded-lg" src={'/blank-ratio.svg'} width={400} height={900} alt="image" />
            <div>
