...
export default function Feature(){
    return(
        <section className="w-full px-[1rem] py-[7rem] max-[600px]:py-[2rem] bg-slate-950">
            ...
            <div className="w-full grid grid-cols-3 gap-3 max-[600px]:grid-cols-1">
                {feature.map((feature) =>(
                    <div key={feature.id} className="px-5 py-7 rounded-lg border border-zinc-300/20 bg-gradient-to-br from-slate-900/30 to-slate-700/30 flexCol items-center gap-3 shadow-xl">
