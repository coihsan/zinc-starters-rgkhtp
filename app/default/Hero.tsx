...
export default function Hero(){
    return (
        <section className="w-full mx-auto max-w-screen-xl px-[1rem] max-[600px]:pt-[2rem] pt-[5rem] gap-5 flex max-[600px]:flex-col-reverse items-center justify-between">
            ...
            <Image className="rounded-md w-auto flex-1 border border-zinc-500" src={'/blankimage.png'} width={300} height={200} alt="Hero" />
        </section>
    )
}